...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_DEL,                         KC_ENT,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, ENTSFT, \
  ...
  [_LOWER] = LAYOUT(
    ...
    KC_LSFT, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_DEL,                         KC_ENT,  KC_N,    KC_M,    KC_LT,   KC_GT,   KC_QUES, ENTSFT, \
    KC_LCTL, KC_LALT, KC_LALT,     _______,      KC_LGUI, KC_SPC, LOWER,           RAISE, KC_BSPC, _______,          KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
  ),
